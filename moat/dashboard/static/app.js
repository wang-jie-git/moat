...
// ── State ──────────────────────────────────
const STATE = {
  data: null, filter: 'all', search: '', timer: null,
    ...
    <div class="modal" style="max-width:420px;">
      ...
      <div class="modal-body">
        <div class="help-section">
          <h3>🟢 这是什么？</h3>
          <p>Moat Dashboard — 项目运行状态监控面板。</p>
        </div>
        <div class="help-section">
          <h3>🎨 颜色含义</h3>
          <p><span style="color:var(--green)">🟢 正常</span> — 运行良好 &nbsp; <span style="color:var(--yellow)">🟡 降级</span> — 有异常 &nbsp; <span style="color:var(--red)">🔴 异常</span> — 需要处理</p>
        </div>
        <div class="help-section">
          <h3>🖱️ 交互说明</h3>
          <p>• 🔍 筛选 — 按状态/关键词过滤</p>
