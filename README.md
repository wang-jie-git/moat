...
> **版本**: v1.1.5 · **PyPI**: `pip install moat-ai` · **GitHub**: [wang-jie-git/moat](https://github.com/wang-jie-git/moat)
>
...
<p align="center">
  <img src="docs/demo-leak-detection.svg" alt="Moat: 泄露风险检测" width="640">
</p>

### 📺 演示：AI 工具系统配置审计

<p align="center">
  <img src="docs/demo-scan-ai.svg" alt="Moat: AI 工具审计" width="640">
</p>
